...
public class SortingStrategyTest : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // 삽입 정렬 테스트 (현재 숫자를 이미 정렬된 부분과 비교하여 삽입)
        ...
        // 선택 정렬 테스트 (가장 작은 숫자를 선택하여 앞으로 이동)
